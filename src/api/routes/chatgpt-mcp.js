 ...
 * Worker isolate recycling is handled gracefully — ChatGPT re-initializes
 * when it gets a 404 for an expired session.
 */
...
/** @type {Map<string, {transport: WebStandardStreamableHTTPServerTransport, server: McpServer, lastAccess: number}>} */
